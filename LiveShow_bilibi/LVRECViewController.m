...
#import "LVRECViewController.h"
#import <AVFoundation/AVFoundation.h>

@interface LVRECViewController ()<AVCaptureAudioDataOutputSampleBufferDelegate,AVCaptureVideoDataOutputSampleBufferDelegate>
...
@implementation LVRECViewController
/**
 *  懒加载聚焦视图
 *
 */
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"LVREC_bilibi";
