...
//属性
#define Strong @property (strong, nonatomic)//strong

#define Weak @property (weak, nonatomic)//weak

#define Assign @property (assign, nonatomic)//assign

#define Copy @property (copy, nonatomic)//copy
